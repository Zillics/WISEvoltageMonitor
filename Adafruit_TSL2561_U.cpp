...
*/
/*!
Modified by Erik Zilliacus 8.4.2018
Replaced Wire.h with i2c_t3.h (for teensy 3.5)
 *
 */
/**************************************************************************/
...
boolean Adafruit_TSL2561_Unified::begin()
{
  ...
  _i2c->setDefaultTimeout(10000); // 10ms
  delay(200);
  return init();
}
...
*/
/**************************************************************************/
boolean Adafruit_TSL2561_Unified::begin(i2c_t3 *theWire)
{
  _i2c = theWire;
  _i2c-> begin(I2C_MASTER, 0x00, I2C_PINS_18_19, I2C_PULLUP_EXT, 400000);
  delay(200);
